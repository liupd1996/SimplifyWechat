...
Java_com_android_simplifywechat_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_org_opencv_wechat_1qrcode_WeChatQRCode_WeChatQRCode(JNIEnv *env, jclass clazz, jstring detector_prototxt_path,
                                                         jstring detector_caffe_model_path, jstring super_resolution_prototxt_path, jstring super_resolution_caffe_model_path) {
    ...
    try {
        ...
        WeChatQRCode *_retval_ = new cv::wechat_qrcode::WeChatQRCode(
...
Java_org_opencv_wechat_1qrcode_WeChatQRCode_delete(JNIEnv *env, jclass clazz, jlong self) {
...
jobject vector_string_to_List(JNIEnv *env, std::vector<std::string> &vs) {
    ...
    jobject result = env->NewObject(juArrayList, m_create, (jint)vs.size());
...
Java_org_opencv_wechat_1qrcode_WeChatQRCode_detectAndDecode_10(JNIEnv *env, jclass clazz,
                                                               jlong self, jlong img_nativeObj, jlong points_mat_nativeObj) {
    using namespace cv::wechat_qrcode;
    ...
    try {
        ...
        WeChatQRCode *me = (cv::wechat_qrcode::WeChatQRCode *) self;
...
extern "C"
JNIEXPORT jobject JNICALL
Java_org_opencv_wechat_1qrcode_WeChatQRCode_detectAndDecode_11(JNIEnv *env, jclass clazz,
                                                               jlong self, jlong img_nativeObj) {
    using namespace cv::wechat_qrcode;
    static const char method_name[] = "WeChatQRCode_detectAndDecode";
    try {
        //LOGD("%s", method_name);
